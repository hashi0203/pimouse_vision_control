...
class VisionTest(unittest.TestCase):
    ...
    def test_put_freq(self):
        ...
        self.assertFalse(turn is None, "direction is not fixed. l: %f, r: %f" % (l_turn_rate, r_turn_rate))
        self.assertEqual(sys.argv[1], turn, "wrong direction. l: %f, r: %f" % (l_turn_rate, r_turn_rate))
